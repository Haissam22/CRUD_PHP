        ...
        <table class="table table-custom ">
          <thead>
            <tr>
              ...
              <th scope="col">EXPERTO TEGNOLOGIA</th>
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?php echo $value['experteg']?></td>
              <td><a name="borrar" id="" class="btn btn-danger" href="borrar.php?id=<?=$value['id']?>&req=delete" role="button">ELIMINAR</a></td>
            </tr> 
            <?php
            }
            ?>
    ...
    <div class="modal fade" id="registrarEstudiantes" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="backdrop-filter: blur(5px)">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" >
        <div class="modal-content" >
          ...
          <form class="col d-flex flex-wrap" action="registrarEstudiante.php" method="post">
                ...
                <div class="mb-3 col-12">
                  <label for="reviw" class="form-label">Review</label>
                ...
                <div class="mb-3 col-12">
                  <label for="skill" class="form-label">Skills</label>
                    <select class="form-select form-select-l" name="skill" id="skills">
                      <option selected>Selecciona</option>
                ...
                <div class="mb-3">
                  <label for="" class="form-label">experto Tecgnologia</label>
                  <input type="text"
                    class="form-control" name="expertoTeg" id="" aria-describedby="helpId" placeholder="">
                </div>
